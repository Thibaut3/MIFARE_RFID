...
private:
    ...
    uint8_t  key_a2[6]= { 0xA0, 0xA1, 0xA2, 0xA3, 0xA4, 0xA5};
    uint8_t  key_b2[6]= { 0xB0, 0xB1, 0xB2, 0xB3, 0xB4, 0xB5};
    uint8_t  key_a3[6]= { 0xC0, 0xC1, 0xC2, 0xC3, 0xC4, 0xC5};
    uint8_t  key_b3[6]= { 0xD0, 0xD1, 0xD2, 0xD3, 0xD4, 0xD5};
